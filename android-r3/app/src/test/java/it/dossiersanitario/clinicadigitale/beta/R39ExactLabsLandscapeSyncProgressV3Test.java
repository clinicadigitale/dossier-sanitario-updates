...
public class R39ExactLabsLandscapeSyncProgressV3Test {
    ...
    @Test public void portraitFrozenLandscapeWideSingleLine() throws Exception {
        ...
        assertTrue(main.contains("Allergie rilevanti"));
    }

    @Test public void selectorUsesExactWindowsParametersWithoutPerOptionRescan() throws Exception {
        String main = read("src/main/java/it/dossiersanitario/clinicadigitale/beta/R6MainActivity.java");
        ...
        assertFalse(selector.contains("labSeries(prefs, id)"));
    }

    @Test public void selectedReportGraphUsesExactImportedWindowsLabValues() throws Exception {
        String main = read("src/main/java/it/dossiersanitario/clinicadigitale/beta/R6MainActivity.java");
    ...
    @Test public void graphMathFromR38RemainsStrictAndRangeBased() throws Exception {
    ...
    @Test public void syncShowsHonestIndeterminateHorizontalProgressAndPhase() throws Exception {
    ...
    @Test public void versionIsFinalR39() throws Exception {
        String gradle = read("build.gradle");
        assertTrue(gradle.contains("versionCode 39"));
        assertTrue(gradle.contains("versionName '1.0.0-android-r39-landscape-exactlabs-sync-progress-test'"));
    }
}
