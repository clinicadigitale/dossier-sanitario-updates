...
public class R20CheckpointRuntimeTest {
    ...
    public void r20PatchUsesDedicatedCheckpointCryptoAndPreservesResume() throws Exception {
        ...
        String crypto = new String(Files.readAllBytes(Paths.get("src/main/java/it/dossiersanitario/clinicadigitale/beta/R20CheckpointCrypto.java")), StandardCharsets.UTF_8);
        ...
        assertTrue(crypto.contains("Autoverifica cifratura checkpoint non riuscita"));
